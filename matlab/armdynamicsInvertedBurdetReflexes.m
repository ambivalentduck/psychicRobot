...
torque_fb=kpgain*kp*((theta_real-theta_desired) + (1/12)*(omega_real-omega_desired))+(kp/50)*(reflexE+2*reflexV);

if nargout>1
    errorV=[theta_real-theta_desired; omega_real-omega_desired];
end
