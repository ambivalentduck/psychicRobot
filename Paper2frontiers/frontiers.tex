...
Humans often interact with uncertain and complicated environments, such as turbulence, crowds, and traffic. Despite our capacity to learn and adapt, some environments evolve too quickly or with too much uncertainty for meaningful learning. In such an environment, planning a specific might seem nonsensical. Instead, a continuous cycle of reaction to the environment seems intuitive. We recently developed an algorithm that could recover the path a person intended to take even if they were forced off that path by environmental disturbances \citep{horowitz2015determining}. Surprisingly, some subjects did not alter their intended even following exposure to unexpected pulses of force. If people continuously reacted to their environment, we should always see some response.
