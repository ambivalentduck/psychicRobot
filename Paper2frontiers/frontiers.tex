...
\title[Realtime Feedback of Intended Trajectory]{Reaching is Better When You Get What You Want: Realtime Feedback of Intended Reaching Trajectory Despite an Unstable Forces}
...
While performance is the best indicator of IF's value, changes in arm stiffness can provide secondary confirmation that subjects are actually getting what they want. Arm stiffness is known to increase during exposure to instability \cite{franklin2003adaptation} and uncertainty \cite{takahashi2001impedance}. We anticipated that these change might also be modulated by presentation of IF. Reduces the effects of environmental instability and presenting the subject with a signal already known to them may make the arm relax and become more compliant. We hypothesized that any elevated arm stiffness from noisy disturbances would decrease when subjects received IF.
