...
\end{equation}
where $x_e$ is the equilibrium trajectory of the actuator. Fourth, we describe the actuator control law using the same expansions,
\begin{equation}
