...
\end{equation}
where $x_e$ is the equilibrium trajectory of the actuator. Linearization is informative here because stable equilibrium points of linearizations of nonlinear systems are also equilibrium points of the nonlinear system\cite[p.~156]{khalil2002nonlinear} as long as the Jacobian is bounded and has a bounded time derivative (Lipschitz continuous)\cite[p.~161]{khalil2002nonlinear}. Fourth, we describe a  control law for the actuator using the same expansions,
\begin{equation}
